                        ...
                        <div class="col-xl-5">
                            ...
                            <nav class="mil-main-menu" id="swupMenu">
                                <ul>
                                    ...
                                    <li class="mil-has-children mil-active"><a href="about.php">About Us</a></li>
            ...
            <div id="swupMain" class="mil-main-transition">
                    ...
                    <div class="container mil-p-120-30">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-lg-6 col-xl-5">
                                ...
                                <div class="mil-mb-90">
                                    <p class="mil-up mil-mb-30">A digital marketing agency is all that you need for your growth, development, and success. But, we do understand you in terms of feasibility, and flexibility. We started our journey as a small digital marketing agency in Kochi but with big dreams, and bigger success goals. With a team of willful professionals, we believe that we’ve been pacing up on the right stepping stones of success, and practicing the right ways of professionalism. Each step we take like other digital marketing companies in Kerala, is far-sighted and fearless.</p>

                                    <p class="mil-up mil-mb-60">AtBott believes that we’re also a digital marketing company in Thrissur which is always within the reach of the clients. We’re just a call or message away from your needs. All you need to do is to share your requirements, plans, thoughts, and concerns, and leave the rest to us. We work, watch, and rework your success consistently, and see to it you are never below the best.</p>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="mil-about-photo mil-mb-90">
                                    ...
                                    <div class="mil-up mil-img-frame" style="padding-bottom: 160%;">
                                        <img src="img/aboutus.jpg" alt="img" class="mil-scale" data-value-1="1" data-value-2="1.2">
                                    </div>
                                </div>
                ...
                <div class="mil-dark-bg">
                    <div class="container  mil-p-120-120">
                        <h2 class="mil-h1 mil-center mil-p-0-120 textwhite">Our <span class="mil-thin">Clients</span></h2>
                        <div class="swiper-container mil-infinite-show mil-up">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame"><img src="img/partners/1.svg" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame"><img src="img/partners/2.svg" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame"><img src="img/partners/3.svg" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame"><img src="img/partners/4.svg" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame"><img src="img/partners/5.svg" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame"><img src="img/partners/6.svg" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row mil-mb-60">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mil-team-card mil-up mil-mb-30">
                                                <img src="img/works/team/kishor_sir.jpg" alt="Team member">
                                                <div class="mil-description">
                                                    <div class="mil-secrc-text">
                                                        <h5 class="mil-muted mil-mb-5"><a href="home-2.html">Kishor Kumar</a></h5>
                                                        <p class="mil-link mil-light-soft mil-mb-10">CEO</p>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mil-team-card mil-up mil-mb-30">
                                                <img src="img/works/team/web-designer.jpeg" alt="Team member">
                                                <div class="mil-description">
                                                    <div class="mil-secrc-text">
                                                        <h5 class="mil-muted mil-mb-5"><a href="home-2.html">Arun Thankaiah</a></h5>
                                                        <p class="mil-link mil-light-soft mil-mb-10">Web Designer</p>
                                                        <ul class="mil-social-icons mil-center">
                                                            <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-behance"></i></a></li>
                                                            <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-dribbble"></i></a></li>
                                                            <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-twitter"></i></a></li>
