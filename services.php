                                    ...
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <a href="webdevelopment.php" class="mil-service-card-lg mil-more mil-accent-cursor mil-offset">
                                                    ...
                                                    <ul class="mil-service-list mil-light mil-mb-30">
                                                        ...
                                                        <li class="mil-up">Static Web Design</li>
                                                        <li class="mil-up">Responsive Web Design</li>
                                                        <li class="mil-up">Dynamic Web Design</li>
                                                    </ul>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="digitalmarketing.php" class="mil-service-card-lg mil-more mil-accent-cursor">
                                                    <h4 class="mil-muted mil-up mil-mb-30">Digital Marketing</h4>
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our creative agency is a team of professionals focused on helping your brand grow.</p>
                                                    <ul class="mil-service-list mil-light mil-mb-30">
                                                        <li class="mil-up">SMO</li>
                                                        <li class="mil-up">SMM</li>
                                                        <li class="mil-up">SEO</li>
                                                        <li class="mil-up">Wireframing</li>
                                                    </ul>
                                                    <div class="mil-link mil-accent mil-arrow-place mil-up">
                                                        <span>Read more</span>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="branding.php" class="mil-service-card-lg mil-more mil-accent-cursor mil-offset">
                                                    <h4 class="mil-muted mil-up mil-mb-30">Branding</h4>
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our creative agency is a team of professionals focused on helping your brand grow.</p>
                                                    <ul class="mil-service-list mil-light mil-mb-30">
                                                        <li class="mil-up">Company Profile & Brochure</li>
                                                        <li class="mil-up">Business Card Design</li>
                                                        <li class="mil-up">Corporate Identity Design</li>
                                                        <li class="mil-up">Wireframing</li>
                                                    </ul>
                                                    <div class="mil-link mil-accent mil-arrow-place mil-up">
                                                        <span>Read more</span>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="seo.php" class="mil-service-card-lg mil-more mil-accent-cursor">
                                                    <h4 class="mil-muted mil-up mil-mb-30">SEO</h4>
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our creative agency is a team of professionals focused on helping your brand grow.</p>
                                                    <ul class="mil-service-list mil-light mil-mb-30">
                                                        <li class="mil-up">SMO</li>
                                                        <li class="mil-up">SMM</li>
